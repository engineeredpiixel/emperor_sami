      ...
      <div className="max-w-4xl mx-auto px-6 sm:px-10 lg:px-16">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-[2.6rem] font-bold text-[#111111] leading-tight mb-4">
            Frequently Asked <span className="text-[#F4511E]">Questions</span>
          </h2>
          ...
          {faqs.map((faq, idx) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span className={`font-bold text-base sm:text-lg transition-colors ${isOpen ? 'text-[#F4511E]' : 'text-gray-900 group-hover:text-[#F4511E]'}`}>
                    {faq.question}
                  </span>
                  <div className={`ml-6 shrink-0 w-8 h-8 rounded-full flex items-center justify-center transition-all duration-300 ${isOpen ? 'bg-[#F4511E] text-white rotate-180' : 'bg-gray-100 text-gray-400 group-hover:bg-[#F9A825] group-hover:text-[#111]'}`}>
