    ...
    <section className="bg-[#FAF9F6] py-24 sm:py-32 overflow-hidden border-t border-gray-200">
      <div className="max-w-4xl mx-auto px-6 sm:px-10 lg:px-16">
        ...
        <div className="text-center mb-16">
          ...
          <h2 
            className="text-3xl sm:text-4xl lg:text-[2.6rem] font-bold text-[#111111] leading-tight mb-4"
            dangerouslySetInnerHTML={{
              __html: t("faq.headline").replace("Questions", `<span class="text-[#D84315]">Questions</span>`)
            }}
          />
