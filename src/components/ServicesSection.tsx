...
const services = [
  {
    ...
    description: "Transform your vision into reality with our comprehensive custom home building services, engineered from the ground up for absolute structural perfection.",
    image: "/custom_home_exterior_1774895595441.png",
  },
  {
    title: "High-End Renovations",
    slug: "high-end-renovations",
    description: "Expand your living space and maximize property value with organically integrated, architecturally stunning home additions and full-scale luxury renovations.",
    image: "/custom_home_interior_1774895577855.png",
  },
  {
    title: "Basement Optimization",
    slug: "basement-optimization",
    description: "Convert your underutilized foundation level into a gorgeous, highly functional living area or exclusive, sound-proof entertainment theater.",
    image: "/card_elite_quality_1774895683555.png",
  },
  {
    title: "Project Management",
    slug: "project-management",
    description: "Comprehensive oversight of your construction timeline. We guarantee complete transparency, unyielding safety compliance, and stringent financial adherence.",
    image: "/card_project_management_1774895647508.png",
  },
  {
    title: "Architectural Drafting",
    slug: "architectural-drafting",
    description: "Collaborative CAD design services that flawlessly blend aesthetic ambition with rigorous structural integrity, forging beautiful residential spaces.",
    image: "/blueprint_bg_1774895613394.png",
  },
  {
    title: "Exterior Improvement",
    slug: "exterior-improvements",
    description: "Elevate your estate's curb appeal with premium concrete flatwork, custom masonry, engineered hardscaping, and permanent property improvements.",
  ...
  return (
    ...
    >
      <div className="max-w-[1500px] mx-auto px-6 sm:px-10 lg:px-16">
        ...
        {/* ── THE X-RAY BLUEPRINT SCANNER GRID ── */}
        <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 xl:gap-12 transition-all duration-[1.5s] ease-[0.16,1,0.3,1] delay-300 will-change-transform ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-24"}`}>
          {services.map((service, i) => {
            ...
            >
              ...
              >
                  {/* The gorgeous Photorealistic payload */}
                  <Image 
                      src={service.image} 
                      alt={service.title}
                      fill 
              ...
              {/* The laser flawlessly matches the `clip-path` transition speed and curve to look like it's wiping the image! */}
              <div 
              ...
              {/* ―――――――――――――――――――――――――――――――――――――――――――――――――――――――――― */}
              {/* LAYER 4: POST-SCAN DATA HUD (Slides up from bottom)      */}
              {/* ―――――――――――――――――――――――――――――――――――――――――――――――――――――――――― */}
              ...
              {/* ―――――――――――――――――――――――――――――――――――――――――――――――――――――――――― */}
              {/* The Hover Geometric Border targeting box                   */}
              {/* ―――――――――――――――――――――――――――――――――――――――――――――――――――――――――― */}
