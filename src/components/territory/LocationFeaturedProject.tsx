...
export default function LocationFeaturedProject({ data }: { data: TerritoryType }) {
         ...
         <div className="flex flex-col md:flex-row gap-12 lg:gap-24 items-center">
            ...
            <div className="w-full md:w-5/12 flex flex-col justify-center">
               ...
               <div className="flex items-center gap-4 mb-6">
                  <span className="text-gray-400 text-[10px] md:text-sm font-black tracking-[0.4em] uppercase">{data.name} Spotlight</span>
               ...
               <div className="bg-white/5 backdrop-blur-md border-[0.5px] border-white/10 p-6 sm:p-8 flex flex-col gap-6 relative shadow-2xl">
                  ...
                  <div>
                     ...
                     <span className="text-[#D8A02A] font-medium text-lg tracking-wide">{data.project.category}</span>
                  </div>
                  ...
                  <div>
                     ...
                     <span className="text-white font-black text-2xl uppercase tracking-tighter">{data.project.timeline}</span>
                  </div>
               </div>
