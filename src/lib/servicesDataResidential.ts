...
const RESIDENTIAL_SERVICES_MAP = [
  ...
  { slug: "timeline-planning", title: "Timeline Planning" },
  { slug: "budget-management", title: "Budget Management" },
  { slug: "quality-control", title: "Quality Control" },
  { slug: "vendor-coordination", title: "Vendor Coordination" },
  { slug: "3d-renderings", title: "3D Renderings" },
  { slug: "floor-plans", title: "Floor Plans" },
  { slug: "material-selection", title: "Material Selection" },
  { slug: "design-consultation", title: "Design Consultation" },
