...
export default function ForgotPasswordPage() {
  ...
  const handleReset = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      setStatus("success");
      setMessage("Success! Please check your email inbox (and spam folder) for a secure reset link.");
    }
  };
    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-[#111] p-8 md:p-10 rounded-xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] border border-white/10 relative z-10 hover:border-[#D8A02A]/50 transition-colors duration-500">
        ...
        <div className="flex flex-col items-center mb-10">
          ...
          <h1 className="text-2xl font-black text-white tracking-widest uppercase mb-2">Reset Password</h1>
          <p className="text-[#888] text-sm text-center">Receive a secure link to update your credentials.</p>
        </div>
