...
for (const slug in territoryData) {
  ...
  // Hero Section
  values.push(`($$territory.${slug}.heroImage$$, $$${section}$$, $$image$$, $$${data.name} Hero Image$$, $$${data.heroImage}$$)`);
  ...
  values.push(`($$territory.${slug}.heroTitleTop$$, $$${section}$$, $$text$$, $$${data.name} Hero Title Top$$, $$${p1}$$)`);
  values.push(`($$territory.${slug}.heroTitleBot$$, $$${section}$$, $$text$$, $$${data.name} Hero Title Bottom$$, $$${p2}$$)`);
  
  values.push(`($$territory.${slug}.heroDesc$$, $$${section}$$, $$text$$, $$${data.name} Hero Subheadline$$, $$${data.heroSubheadline}$$)`);
  ...
  if (data.bylawFocus && data.bylawFocus.length >= 2) {
    values.push(`($$territory.${slug}.bylaw1Title$$, $$${section}$$, $$text$$, $$${data.name} Bylaw Item 1 Title$$, $$${data.bylawFocus[0].title}$$)`);
    values.push(`($$territory.${slug}.bylaw1Desc$$, $$${section}$$, $$text$$, $$${data.name} Bylaw Item 1 Description$$, $$${data.bylawFocus[0].desc}$$)`);
    values.push(`($$territory.${slug}.bylaw2Title$$, $$${section}$$, $$text$$, $$${data.name} Bylaw Item 2 Title$$, $$${data.bylawFocus[1].title}$$)`);
    values.push(`($$territory.${slug}.bylaw2Desc$$, $$${section}$$, $$text$$, $$${data.name} Bylaw Item 2 Description$$, $$${data.bylawFocus[1].desc}$$)`);
  }
