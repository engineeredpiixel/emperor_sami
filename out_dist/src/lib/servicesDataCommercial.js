...
exports.commercialServicesData = void 0;
exports.commercialServicesData = {};
var COMMERCIAL_SERVICES_MAP = [
...
COMMERCIAL_SERVICES_MAP.forEach(function (item, i) {
    var slug = item.slug, title = item.title, imgUrl = item.imgUrl;
    exports.commercialServicesData[slug] = {
        id: slug,
        slug: slug,
        heroTitle: title,
        heroSubtitle: "Industrial-grade ".concat(title.toLowerCase(), " executing complex corporate blueprints."),
        heroImage: "/optimized_v2/srv_".concat(slug, "_hero.webp"),
        capabilityImage: "/optimized_v2/srv_".concat(slug, "_cap.webp"),
        description: "In the commercial division, Emperor Sami enforces rigid structural protocols. Our operations are designed strictly for scalable B2B developments, ensuring extreme durability and absolute code compliance in every ".concat(title, " execution."),
        details: [
        ...
        process: [
            { step: "01 Phase", desc: "Analyzing corporate objectives for your ".concat(title, " requirements.") },
        ...
        caseStudy: {
            title: "".concat(title, " Corporate Flagship"),
            image: imgUrl,
        ...
        faqs: [
            { q: "Can you handle large-scale ".concat(title, "?"), a: "Emperor Sami's commercial division deploys massive B2B developments." },
